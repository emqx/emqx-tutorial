...
With the above configuration, we should be able to finish the demonstration in this section. For more details about RabbitMQ, please refer to [RabbitMQ document](https://www.rabbitmq.com).
